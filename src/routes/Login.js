       ...
       const userClick = () => {
        ...
        return (
          <div className={color ? "header header-bg" : "header"}>
            <><h1>{listnew.FirstName} {listnew.LastName}</h1></>
            <ul className={click ? "nav-menu active":"nav-menu"}>
              <li>
                  <a onClick={fun_home}>Home</a>
              </li>
              <li>
                  <a onClick={fun_project}>Project</a>
              </li>
              <li>
                  <a onClick={fun_about}>About</a>
              </li>
              <li>
                  <a onClick={fun_contact}>Contact</a>
              </li>
              <li>
                  <a onClick={userSignOut}>Log Out</a>
              </li>
            </ul>
          ...
          <div className='hero'>
            ...
            {/* {listnew.map(list =>(
              ...
              <div>
                  ...
                  <Link className='btn btn-light'>Contact</Link>
              </div>
            </div>
          </div>
        )
            ...
            return (
              <div className='work-container'>
                  ...
                  <div className='project-container'>
                              ...
                              <WorkCard imgsrc={listnew.Project2_img} title={listnew.Project2_title} text={listnew.Project2_Info} view={listnew.Project2_URL} />
